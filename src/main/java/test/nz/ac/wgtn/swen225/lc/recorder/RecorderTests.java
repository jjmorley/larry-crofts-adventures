...
public class RecorderTests {
  ...
  /**
   * Setup game, recorder, and test file.
   */
  @Before
  public void setUp() {
  ...
  /**
   * Test saving works with different moves and file name.
   */
  @Test
  public void testSave2() {
    ...
    File uniqueTestFile =
            new File("src/main/resources/Recorder/unique-test-recorded-game.json");
